...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'role' => [
            'driver' => 'mysql',
            'host' => env('ROLE_DB_HOST', '127.0.0.1'),
            'port' => env('ROLE_DB_PORT', '3306'),
            'database' => env('ROLE_DB_DATABASE', 'forge'),
            'username' => env('ROLE_DB_USERNAME', 'forge'),
            'password' => env('ROLE_DB_PASSWORD', ''),
            'unix_socket' => env('ROLE_DB_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
            'strict' => true,
        ...
        'activity' => [
            ...
            'database' => env('ACTIVITY__DB_DATABASE', 'forge'),
            'username' => env('ACTIVITY_DB_USERNAME', 'forge'),
            'password' => env('ACTIVITY_DB_PASSWORD', ''),
            'unix_socket' => env('ACTIVITY_DB_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
            'strict' => true,
        ...
        'asset' => [
            ...
            'port' => env('ASSET_DB_PORT', '3306'),
            'database' => env('ASSET_DB_DATABASE', 'forge'),
            'username' => env('ASSET_DB_USERNAME', 'forge'),
            'password' => env('ASSET_DB_PASSWORD', ''),
            'unix_socket' => env('ASSET_DB_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
            'strict' => true,
        ...
        'payment' => [
            ...
            'database' => env('PAYMENT_DB_DATABASE', 'forge'),
            'username' => env('PAYMENT_DB_USERNAME', 'forge'),
            'password' => env('PAYMENT_DB_PASSWORD', ''),
            'unix_socket' => env('PAYMENT_DB_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
            'strict' => true,
